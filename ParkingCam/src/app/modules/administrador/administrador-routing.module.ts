...
const routes: Routes = [
  ...
  {
    path: 'lista-personas', canActivate: [AuthguardGuard], data: {expectedRoles: ['Administrador', 'Secretaria'] },
    loadChildren: () => import("./lista-personas/lista-personas.module").then(m => m.ListaPersonasModule)

  },

  {
    path: 'lista-vehiculos', canActivate: [AuthguardGuard], data: {expectedRoles: ['Administrador', 'Secretaria'] },
    loadChildren: () => import("./lista-vehiculos/lista-vehiculos.module").then(m => m.ListaVehiculosModule)
  },

  {
    path: 'lista-registros', canActivate: [AuthguardGuard], data: {expectedRoles: ['Administrador', 'Secretaria'] },
    loadChildren: () => import("./lista-registros/lista-registros.module").then(m => m.ListaRegistrosModule)
  },

  {
    path: 'lista-bloques', canActivate: [AuthguardGuard], data: {expectedRoles: ['Administrador', 'Secretaria'] },
    loadChildren: () => import("./lista-bloques/lista-bloques.module").then(m => m.ListaBloquesModule)
  },

  {
    path: 'lista-usuarios', canActivate: [AuthguardGuard], data: {expectedRoles: ['Administrador', 'Secretaria'] },
    loadChildren: () => import("./lista-usuarios/lista-usuarios.module").then(m => m.ListaUsuariosModule)
  },

  {
    path: 'registro-personal', canActivate: [AuthguardGuard], data: {expectedRoles: ['Administrador', 'Secretaria'] },
    loadChildren: () => import("./registra-personal/registra-personal.module").then(m => m.RegistraPersonalModule)
  },

  {
    path: 'control-bloques', canActivate: [AuthguardGuard], data: {expectedRoles: ['Administrador', 'Secretaria'] },
    loadChildren: () => import("./control-bloques/control-bloques.module").then(m => m.ControlBloquesModule)
  },

  {
    path: 'profile', canActivate: [AuthguardGuard], data: {expectedRoles: ['Administrador', 'Secretaria'] },
    loadChildren: () => import("./profile/profile.module").then(m => m.ProfileModule)
  },
  {
    path: 'detalle-personas/:id', canActivate: [AuthguardGuard], data: {expectedRoles: ['Administrador', 'Secretaria'] },
    loadChildren: () => import("./detalle-personas/detalle-personas.module").then(m => m.DetallePersonasModule)
  },
  {
    path: 'detalle-vehiculos/:id', canActivate: [AuthguardGuard], data: {expectedRoles: ['Administrador', 'Secretaria'] },
    loadChildren: () => import("./detalle-vehiculos/detalle-vehiculos.module").then(m => m.DetalleVehiculosModule)
  },

  {
    path: 'detalle-registros/:id', canActivate: [AuthguardGuard], data: {expectedRoles: ['Administrador', 'Secretaria'] },
    loadChildren: () => import("./detalle-registros/detalle-registros.module").then(m => m.DetalleRegistrosModule)
  },

  {
    path: 'editar-persona/:id', canActivate: [AuthguardGuard], data: {expectedRoles: ['Administrador', 'Secretaria'] },
    loadChildren: () => import("./editar-persona/editar-persona.module").then(m => m.EditarPersonaModule)
  },

  {
    path: 'editar-vehiculo/:id', canActivate: [AuthguardGuard], data: {expectedRoles: ['Administrador', 'Secretaria'] },
  ...
  {
    path: 'registro-vehiculo', canActivate: [AuthguardGuard], data: {expectedRoles: ['Administrador', 'Secretaria'] },
    loadChildren: () => import("./register-vehiculo/register-vehiculo.module").then(m => m.RegisterVehiculoModule)
  },
  {
    path: 'registro-usuario', canActivate: [AuthguardGuard], data: {expectedRoles: ['Administrador', 'Secretaria'] },
    loadChildren: () => import("./register-user/register-user.module").then(m => m.RegisterUserModule)
  },
  {
    path: 'registro-bloque', canActivate: [AuthguardGuard], data: {expectedRoles: ['Administrador', 'Secretaria'] },
